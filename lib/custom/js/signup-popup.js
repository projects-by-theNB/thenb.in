...
var SignupPopup = (function () {
   ...
   *      email_verified) into NTProfile so the chatbot, activity-emailer,
  ...
  function handleGoogleResponse(response) {
    if (response.credential) {
      try {
        ...
        // 1. Persist into the shared NTProfile so the chatbot et al.
        //    recognise this visitor on subsequent interactions.
        if (window.NTProfile && typeof window.NTProfile.update === 'function') {
