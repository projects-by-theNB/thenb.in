...
var AppConfig = {
  ...
  mailerSecretKey:   '175763e2-e0da-4268-9945-f1cbf37ba74c',
  ...
  // Used by visitor-profile.js (visit tracking), chatbox-integration.js
  // (auto-tag), and cta-tracking.js (event labels). Single source of truth.
  productByPage: {
