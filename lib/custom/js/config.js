...
var AppConfig = {
  ...
  // Used by lib/custom/js/signup-popup.js.
  signupPopup: {
    delayMs:           10000,            // initial show after page load
    repeatIntervalMs:  4 * 60 * 1000     // gap between subsequent shows for users who keep closing
  }
};
