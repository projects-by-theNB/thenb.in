...
var AppConfig = {
  ...
  // Clarity loader is inlined at the top of every HTML page so it can fire
  // before user interaction — to swap the ID, grep-replace the literal
  // 'wu8165tr26' across all *.html files. This key is kept
  // only as documentation of where the ID lives.
  ...
  // and click-tracking.js (event labels). Single source of truth.
  productByPage: {
  ...
  signupPopup: {
    delayMs:           60 * 1000,        // initial show after page load (1 min)
